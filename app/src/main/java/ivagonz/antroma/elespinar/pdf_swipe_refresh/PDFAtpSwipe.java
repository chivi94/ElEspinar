...
public class PDFAtpSwipe extends PDFSwipe {
    public PDFAtpSwipe(Context context, SwipeRefreshLayout swipeRefreshLayout, ViewPager viewPager, TabLayout tabLayout) {
    ...
    public void setSwipeRefreshLayoutSettings() {
        getSwipeRefreshLayout().setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                PDFAtpAsyncTask pdfAsyncTask = new PDFAtpAsyncTask(getContext(), getViewPager(), getTabLayout());
